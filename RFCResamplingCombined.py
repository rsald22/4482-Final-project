...
# Apply SMOTE to data - 1.0 sampling strategy means min and maj categories have same number of samples
...
rf.fit(X_resampled, y_resampled) # fit model with resampled data set


y_pred = rf.predict(X_validation) # predict validation data
...
plt.savefig('RFCconfMatrix.png') # save to files
...
plt.savefig("rfccombinedprc") # save to files
